...
public class Termino {
    ...
    public int hashCode() { 
        ...
        /** COMPLETAR: calcular el valor de res de forma EFICIENTE, i.e. usando la regla de Horner */
        
        int n = this.palabra.length();
        for(int i = 0; i < n; i++){
            res = (res * baseHashCode) + this.palabra.charAt(i);
        }
    ...
    public boolean equals(Object otro) {
        /* COMPLETAR */
        return (otro instanceof Termino) && ((Termino) otro).valorHash == (this.valorHash);
    }
