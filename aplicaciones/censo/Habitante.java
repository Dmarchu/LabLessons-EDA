...
public class Habitante implements Comparable<Habitante>{
    ...
    public boolean equals(Object o) {
        // COMPLETAR
        return (o instanceof Habitante) && ((Habitante) o).dni == (this.dni);
    ...
    public int compareTo(Habitante otro) {
        // COMPLETAR
        if(this.apellido1.compareTo(otro.getApellido1()) !=0){
            return this.apellido1.compareTo(otro.getApellido1());
        } else if(this.apellido2.compareTo(otro.getApellido2()) != 0){
            return this.apellido2.compareTo(otro.getApellido2());
