 ...
 **/
 ...
 //EJERCICIO DE EXAMEN EN LA PARTE DE ABAJO DEL TODO
...
public class ABB<E extends Comparable<E>> {
    ...
    protected NodoABB<E> construirEquilibrado(E[] v, int ini, int fin) {
        ...
        //Calculo la mitad
        int med = (ini + fin) / 2;
        //Crear nodo con elemento en v[mitad] haciendo dos llamadas recursivas más para los posibles hijos
        NodoABB<E> nodo = new NodoABB<>(v[med], construirEquilibrado(v, ini, med - 1), construirEquilibrado(v, med + 1, fin));
        
        return nodo; // PARA QUE COMPILE *** CAMBIAR
    }
    ...
    public void reconstruirEquilibrado() {        
        // COMPLETAR     
        E[] datos = this.toArrayInOrden();
        raiz = construirEquilibrado(datos, 0, datos.length - 1);
    }
    ...
    public boolean hayQueReconstruirEquilibrado() {
        if (raiz == null) return false;
        double umbral = (this.raiz.talla - 1) / 2;
        return altura(this.raiz) >= umbral;
    }
    
    private int altura(NodoABB<E> nodo) {
